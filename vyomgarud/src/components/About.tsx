  ...
  return (
    <div className="px-4 py-8 pb-10">
      ...
      <div className="p-2 space-y-8">
        {/* ---- Block 1 ---- */}
        <div
          className="space-y-3  text-black text-xl font-normal dark:text-white"
        ...
        >
          <motion.p {...fadeInLeft} transition={{ ...fadeInLeft, delay: 0 }}>
            ...
            management, avionics, and mission software — so the final system
            behaves predictably under stress and delivers consistent outcomes
        ...
        <motion.p
          ...
          className="text-xl font-normal text-black dark:text-white leading-relaxed"
        >
        ...
        <div
          className="space-y-3 cursor-pointer select-none text-black text-xl font-normal dark:text-white"
          onClick={() => setOpen(true)}
        >
          <motion.p
            initial={{ opacity: 0, x: 30 }}
